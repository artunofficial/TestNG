...
public class C_Register extends E_TestBase{

	public C_Register() throws Exception {
		super();
	...
	public void verifyRegisterWithMandatoryDetails() {
		...
		driver.findElement(By.cssSelector("input#input-email")).sendKeys("amsuyu@gmail.com");
		driver.findElement(By.cssSelector("input#input-telephone")).sendKeys("9876543210");
		driver.findElement(By.cssSelector("input#input-password")).sendKeys("amsuyu");
		driver.findElement(By.cssSelector("input#input-confirm")).sendKeys("amsuyu");
	...
	public void verifyRegisterWithAllDetails() {
		driver.findElement(By.cssSelector("input#input-firstname")).sendKeys("Selenium");
		driver.findElement(By.cssSelector("input#input-lastname")).sendKeys("Panda");
		driver.findElement(By.cssSelector("input#input-email")).sendKeys("amsuyu1@gmail.com");
		driver.findElement(By.cssSelector("input#input-telephone")).sendKeys("9876543210");
		driver.findElement(By.cssSelector("input#input-password")).sendKeys("amsuyu");
		driver.findElement(By.cssSelector("input#input-confirm")).sendKeys("amsuyu");
