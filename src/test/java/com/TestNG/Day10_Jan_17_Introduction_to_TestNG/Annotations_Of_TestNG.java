...
public class Annotations_Of_TestNG {
	...
	//Test Case < Test Method < Test Class < Test Suite
	...
	public void beforeTestMethod() {
		System.out.println("Before Test Annotation gets executed after BeforeSuite annotation - so this is 2nd");
	}
	...
	@BeforeMethod //Most important Annotation
	public void beforeMethodMethod() {
		System.out.println("This will be executed after Before Class Annotation - Rank 4th");
	}
	
	//!!!!!!!THIS MOST Most important Annotation:!!!!!
	@Test
	public void testcase1() {
		System.out.println("The sum of 2 and 3 is : " + (2+3));
	}
	
	@AfterMethod //Most important Annotation
