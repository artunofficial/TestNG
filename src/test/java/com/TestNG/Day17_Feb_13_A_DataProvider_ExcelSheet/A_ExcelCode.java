package com.TestNG.Day17_Feb_13_A_DataProvider_ExcelSheet;
...
public class A_ExcelCode {
	...
	public Object[][] getTNExcelLoginData() throws Exception {
		Object[][] data = A_ExcelCode.readFromExcelSheetTNLogin("LoginTN");
		return data;
	}
	...
	//5. Create the Object of FileInputStream class and pass the path of the Excel sheet in its Constructor
		 ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\com\\TestNG\\Day17_Feb_13_A_DataProvider_ExcelSheet\\ExcelData.xlsx");
